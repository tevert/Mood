namespace Mood.Util
{
    ...
    public static class Extensions
    {
            ...
            where T : class
        {
            ...
            var updatingProperties = updatingExpression != null ? GetProperties<T>(updatingExpression).Where(pi => IsModifiedable(pi.PropertyType)).ToList() : new List<PropertyInfo>();
